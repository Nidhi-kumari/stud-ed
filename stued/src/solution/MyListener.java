	...
	public void contextInitialized(ServletContextEvent arg0) {
      ...
      try{
       ...
       if(status==0)
		...
		PreparedStatement ps=con.prepareStatement("CREATE TABLE  NEWACCOUNT(USERNAME VARCHAR2(4000),PASSWORD VARCHAR2(4000),REPASSWORD VARCHAR2(4000),,COLLEGE VARCHAR2(4000),BRANCH VARCHAR(4000),EMAIL VARCHAR(4000),PHONE NUMBER, PRIMARYKEY(EMAIL)");
		ps.executeUpdate();
